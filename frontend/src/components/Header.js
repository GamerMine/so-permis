                ...
                <nav style={style.nav} >
                    <div>
                        <Grid marginTop={{lg:"15px"}} style={style.gridContainer} justifyContent={{"sd":"center" , md:"end"}} display={{"sd":"grid" , lg:"flex", base:"grid"}} gridTemplateColumns={{"sd":"repeat(3,1fr)"}}>
                            <GridItem><a style={{...style.gridElement, ...style.navLinkBig}} href="/">Accueil</a></GridItem>
                            <GridItem><a style={{...style.gridElement, ...style.navLinkBig}} href="#">Permis de conduire</a></GridItem>
                            <GridItem><a style={{...style.gridElement, ...style.navLinkBig}} href="/CodeDeLaRoute">Code de la route</a></GridItem>
                            <GridItem><a style={{...style.gridElement, ...style.navLinkBig}} href="#">Qui sommes-nous ?</a></GridItem>
                            <GridItem><a style={{...style.gridElement, ...style.navLinkBig}} href="#">Contact</a></GridItem>
                        </Grid>
                    </div>
                </nav>
                </Grid>
